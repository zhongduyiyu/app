...
export default {
  ...
  mounted(){
    ...
    container.addEventListener("click",()=>{
      ...
      this.countClick++
      if(this.showToolBar===true&&this.countClick>1){
  ...
  methods: {
    ...
    onDblClick(){
      ...
      toolBar.style.top=this.mousePosition.clientY+20+"px"
    ...
    onEditorFocus() {
      ...
      if(selected&&!this.isClickToolBar){
        //选中文字进行toolBar的显示
        let toolBar = document.querySelector(".ql-toolbar")
        toolBar.style.left=this.mousePosition.clientX+"px"
        toolBar.style.top=this.mousePosition.clientY+20+"px"
    ...
    saveEditContent(){
      let data = this.$refs.myQuillEditor.quill.getContents()
      console.log(data);
    }
  }
};
