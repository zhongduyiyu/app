 ...
 * @Version: 0.01
 * @Autor: MoXu
 * @Date: 2021-01-11 14:17:44
 * @LastEditors: MoXu
 * @LastEditTime: 2021-01-11 14:31:07
-->
<template>
  <div>
    <vxe-toolbar>
      <template v-slot:buttons>
        <vxe-button @click="$refs.xTree.toggleTreeExpand(tableData[0], true)"
          >切换第一个</vxe-button
        >
        <vxe-button @click="$refs.xTree.setTreeExpand(tableData[2], true)"
          >展开第三个</vxe-button
        >
